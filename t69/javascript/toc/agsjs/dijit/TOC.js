  ...
  var TOC = declare("agsjs.dijit.TOC", [_Widget],{
	...
	if (this.layerInfos.length == 0) {
		emptyTOC = '<h2>Быстрый старт</h2>\n' +
					...
					'<p>Полную справку о программе можно получить здесь - <a href="http://cgis.allgis.org/mapedit/documentation/help.html" target="_blank">http://cgis.allgis.org/mapedit/documentation/help.html</a>.</p>\n' +
					'<hr /><p>© 2013 ALGIS LLC<br />С вопросами и предложениями обращайтесь по адресу <a href="mailto:mp@allgis.org?subject=mapedit">mp@allgis.org</a></p>\n';
