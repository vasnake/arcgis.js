...
function() {
  var config = {
    ...
    helperServices: {
       geometry:{
        url: location.protocol + "//cgis.allgis.org/arcgis/rest/services/Utilities/Geometry/GeometryServer"
       },
       printTask: {
        url: location.protocol + "//cgis.allgis.org/arcgis/rest/services/Utilities/PrintingTools/GPServer/Export%20Web%20Map%20Task"
       },
       geocode: [{
        url: location.protocol + "//geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer"
       // url: location.protocol + "//maps.rosreestr.ru/ArcGIS/rest/services/Address/Locator_Composite/GeocodeServer"
       }]
    }
};
